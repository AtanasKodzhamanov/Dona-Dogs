...
class Dog(models.Model):
    ...
    STATUS_CHOICES = [(x, x) for x in ("Active", "New", "Dead", "Adopted", "Sick")]
...
class NoticeBoard(models.Model):
    ...
    LOCATION_CHOICES = [
        (x, x)
        for x in ("Gallery", "About", "Infirmary", "Adoptions", "Donations", "Home")
    ]
...
class ContactFormModel(models.Model):
    ...
    email = models.EmailField(max_length=EMAIL_MAX_LENGTH)
    name = models.CharField(max_length=NAME_MAX_LENGTH)
    subject = models.TextField(max_length=SUBJECT_MAX_LENGTH)
